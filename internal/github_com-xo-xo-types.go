// Code generated by 'yaegi extract github.com/calebhiebert/xo/types'. DO NOT EDIT.

package internal

import (
	"github.com/calebhiebert/xo/types"
	"reflect"
)

func init() {
	Symbols["github.com/calebhiebert/xo/types/types"] = map[string]reflect.Value{
