// Code generated by 'yaegi extract github.com/calebhiebert/xo/models'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/calebhiebert/xo/models/models"] = map[string]reflect.Value{
